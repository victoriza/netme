package es.moodbox.humantower.spring.cfg;
...
import es.moodbox.humantower.handlers.StringProtocolInitalizer;
import es.moodbox.humantower.service.HumanTowerService;
import es.moodbox.humantower.service.impl.HumanTowerIterativeImpl;

/**
 * The Spring configuration not xml but programmatic, minimal Spring IoC config to wire the project 
 * 
 * @author victor
 */

@Configuration
@ComponentScan("es.moodbox.humantower")
...
public class SpringConfig {
	...
	@Bean(name = "htService")
	public HumanTowerService humanTowerService() {
		return new HumanTowerIterativeImpl();
	}
